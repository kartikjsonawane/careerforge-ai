    ...
    <div className="min-h-screen bg-[#080b14] flex items-center justify-center p-4">
      ...
      >
        <div className="glass-card p-8">
          ...
          <p className="text-white/50 text-sm mb-7">Sign in to continue your career journey</p>

          {/* Google OAuth */}
          <button className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-white/10 hover:border-white/20 bg-white/3 hover:bg-white/5 text-white text-sm font-medium transition-all mb-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/auth/forgot" className="text-xs text-forge-400 hover:text-forge-300 transition-colors">Forgot password?</Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-white/40 mt-6">
            ...
            <Link href="/auth/register" className="text-forge-400 hover:text-forge-300 font-medium transition-colors">
              Create one free
            </Link>
          </p>
        </div>
